 ...
 */
public class SoJavaDataModal extends AbstractJavaDataModal implements JavaDataModal {

    public SoJavaDataModal(Class baseClass) {
        super(baseClass);
    }
    ...
    public String getBasePackageLocation() {
        return ConfigHelper.getString("so.class.package");
    }

    @Override
    public String getExtendsClassName() {
        return ConfigHelper.getString("so.class.extends");
    }
    ...
    public String getClassSimpleName() {
        return getBaseClass().getSimpleName() + "So";
    }
